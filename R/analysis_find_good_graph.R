...
i <- find_graphs_with_highest_int_pos(all_results = all_results, obj_fct = element_in_most_of_the_6_sets)
...
if (plot == "sum over all graphs") {
  sum_all_effects(all_results, weight_effects_on_by = weight_effects_on_by)
}
