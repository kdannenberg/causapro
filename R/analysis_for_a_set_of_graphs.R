...
analyse_set_of_graphs <- function(
  ...
  if (plot == "best_graph") {
    ...
    effects_over_all_graphs_on_of <- compute_over_all_graphs(all_results = all_results, int_pos = int_pos, weight_effects_on_by = weight_effects_on_by, 
...
analyse_set_of_graphs(direction = "both", measure = measure, alpha = alpha, min_pos_var = min_pos_var)
