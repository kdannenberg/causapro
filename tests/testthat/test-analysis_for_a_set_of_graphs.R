test_sum_all_effects <- function() {
  ...
  return(compute_over_all_graphs(fake_results, position = "372", function_over_all_graphs = "sum", weight_effects_on_by = "",
...
test_that("sum_all_effects works correctly", {
  expect_equal(test_sum_all_effects()$overAllGraphs_of, desired_sum_of)
  expect_equal(test_sum_all_effects()$overAllGraphs_on, desired_sum_on)
})
